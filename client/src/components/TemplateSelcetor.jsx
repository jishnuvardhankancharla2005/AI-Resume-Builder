...
const TemplateSelcetor = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        {
            id: "classic",
            name: "Classic",
            preview: "A clean, traditional resume format with clear sections and personal typography"
        },
        {
            id: "modern",
            name: "Modren",
...
export default TemplateSelcetor

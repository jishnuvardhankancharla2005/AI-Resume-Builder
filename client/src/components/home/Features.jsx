...
const Features = () => {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
                ...
                <Title title='Build your resume' description='Our stramlined process helps you create a proffessional resume in minutes with intelligent AI-powered tools and features.'/>

            <div className="flex flex-col md:flex-row items-center cl:-mt-10 justify-center">
                <img

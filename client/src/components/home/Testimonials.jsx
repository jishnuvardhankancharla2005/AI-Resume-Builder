  ...
  return (
    ...
    <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
        <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
            ...
            <Title title="Don't just take our words" description="Here what our users say about us. We're always looking for ways to improve. If you have a positive expreience with us, leave a reivew."/>
        </div>
